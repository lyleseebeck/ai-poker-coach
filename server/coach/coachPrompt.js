...
const INITIAL_SYSTEM_PROMPT = [
  ...
  '- Keep heroMadeHandCategory and heroPairingDetail consistent with the board and hole cards.',
    ...
    assistant: {
      ...
      analysis: {
        ...
        factCheck: {
          ...
          heroMadeHandCategory: requiredFactCheck.heroMadeHandCategory || 'high_card',
          heroPairingDetail: requiredFactCheck.heroPairingDetail || 'none',
        },
      },
    },
  };
